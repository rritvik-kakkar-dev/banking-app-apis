...
function CreditModal({ onClose, onSuccess }) {
    ...
    const handleCredit = async () => {
        ...
        setLoading(true);
        try {
            await api.post("/api/user/credit", {
                accountNumber,
            ...
            toast.success(
                `₹${Number(amount).toLocaleString("en-IN")} credited successfully`
            );
            ...
            setError("Failed to credit amount. Try again.");
            setLoading(false);
        }
    };
            ...
            <div className="bg-[#fefefe] border border-[#e8e8e3] rounded-2xl p-6 w-96 shadow-xl">
                ...
                <div className="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <h2 className="text-gray-900 font-bold text-lg">Credit Amount</h2>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="mb-6">
                    <label className="block text-gray-500 text-xs font-semibold uppercase tracking-wider mb-2">
                        Source <span className="text-gray-300 normal-case">(optional)</span>
                    </label>
                    <input
                        type="text"
                        className="w-full bg-[#f0f0eb] border border-[#e8e8e3] focus:border-blue-400 focus:ring-2 focus:ring-blue-100 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-300 outline-none transition-all text-sm"
